 ...
 */
@Component(GeneratorType.WITH_DATE_YMD_CYCLE_BY_YMD)
public class WithinDateGenerator4YMDCycleByYMDImpl extends AbstractWithinDateGeneratorImpl {
    ...
    public String appendDateToGeneratorId(String generatorId) {
        return generatorId + "-" + DateKit.format(DateKit.now(), DateFormat.YMD.desc());
    }
}
