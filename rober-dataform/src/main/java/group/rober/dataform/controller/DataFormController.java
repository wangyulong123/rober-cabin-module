...
//        DataForm ret = BeanKit.deepClone(dataForm);
    ...
    public DataFormCombiner<PaginationData<?>> queryDataList(@PathVariable("form") String form
    ...
    public DataFormCombiner<PaginationData<?>> queryTextDataList(@PathVariable("form") String form
            , @MatrixVariable(pathVar = "param") MultiValueMap<String, Object> paramMatrix
            , @MatrixVariable(pathVar = "sort") MultiValueMap<String, Object> sortMatrix
            , @PathVariable("size") Integer size, @PathVariable("index") Integer index
    ) {
        //通过self调用，这样可以确保AOP生效
        DataFormCombiner<PaginationData<?>> ret = self.queryDataList(form, paramMatrix, sortMatrix, size, index);
        //把字典转为名称
    ...
    public void queryExcelDataList(@PathVariable("form") String form
        ...
        DataFormCombiner<PaginationData<?>> ret = queryTextDataList(form, paramMatrix, sortMatrix, size, index);
...
//        return TreeNodeKit.buildTree(dictItems, DictItemNode::getSortCode);
    ...
    private void fixDate(DataForm dataForm, List<MapData> mapDataList) {
        List<DataFormElement> elements = dataForm.getElements();
        for (DataFormElement element : elements) {
            if (element.getDataType() == ElementDataType.Date) {
                String code = element.getCode();
    ...
    protected List<?> saveBeanDataList(DataFormAddon addon, List<MapData> dataList) {
        DataForm dataForm = addon.dataForm;
    ...
    protected List<?> saveMapDataList(DataFormAddon addon, List<MapData> dataList) {
        DataForm dataForm = addon.dataForm;
    ...
    public List<?> saveDataList(DataFormAddon addon, List<MapData> dataList) {
        DataForm dataForm = addon.dataForm;
    ...
    public Object saveDataOne(@PathVariable("form") String form, @RequestBody MapData dataOne) {
        ...
        List<MapData> dataList = new ArrayList<MapData>(1);
    ...
    protected int deleteDataList(DataFormAddon addon, List<MapData> dataList) {
        DataForm dataForm = addon.dataForm;
        ValidateKit.notEmpty(dataList, "the list data is empty");
        //取绑定在dataform上的数据处理Handler
        FormDataModelType dataModelType = addon.dataForm.getDataModelType();
    ...
    protected int deleteBeanDataList(DataFormAddon addon, List<MapData> dataList) {
    ...
    protected int deleteMapDataList(DataFormAddon addon, List<MapData> dataList) {
        DataForm dataForm = addon.dataForm;
    ...
    public List<ValidateResult> validateDataList(@PathVariable("form") String form, @RequestBody List<MapData> dataList) {
        //取数据以及dataform并进行相关的校验
        DataFormAddon addon = getDataFormAddon(form);
        DataForm dataForm = addon.dataForm;
        ValidateKit.notNull(dataForm, "dataform not found:" + form);
    ...
    protected List<ValidateResult> validateDataList(DataFormAddon addon, List<MapData> dataList) {
        DataForm dataForm = addon.dataForm;
        ValidateKit.notEmpty(dataList, "the list data is empty");
        //取绑定在dataform上的数据处理Handler
        FormDataModelType dataModelType = addon.dataForm.getDataModelType();
    ...
    protected List<ValidateResult> validateBeanDataList(DataFormAddon addon, List<MapData> dataList) {
        DataForm dataForm = addon.dataForm;
    ...
    protected List<ValidateResult> validateMapDataList(DataFormAddon addon, List<MapData> dataList) {
        DataForm dataForm = addon.dataForm;
